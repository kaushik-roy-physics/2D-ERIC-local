...
This repository contains the codes (.ipynb, .py) for generating the figures and movies presented in the paper titled "Foci, waves, excitability: self-organization of phase waves in a model of asymmetrically coupled embryonic oscillators" by Kaushik Roy and Paul Francois, Phys. Rev. E 113, 014405, doi: https://doi.org/10.1103/7ph2-kj8g. In addition, it contains:
